...
class ProjectFile extends Model
{
    ...
    /**
     * Get URL accessible via project API token (for generated apps).
     * This URL can be used directly in img src or fetch from generated apps.
     */
    public function getApiUrl(): string
    {
        return url("/api/app/{$this->project_id}/files/{$this->filename}");
    }
