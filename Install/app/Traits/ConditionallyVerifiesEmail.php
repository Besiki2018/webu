...
trait ConditionallyVerifiesEmail
{
     ...
     * Default false so that after install (or mark-installed) users can reach dashboard without verifying.
     */
    public function shouldVerifyEmail(): bool
    {
        return SystemSetting::get('require_email_verification', false);
    }
