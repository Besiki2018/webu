...
class DemoCleanup extends Command
{
    ...
    {
        // Guard: Only run in demo mode; never when APP_ENV is production
        if (env('APP_ENV') === 'production') {
            $this->error('Demo cleanup is disabled when APP_ENV=production. This command would delete data.');
    ...
    private function resetDatabase(): void
    {
        ...
        $deletedUsers = User::where('role', '!=', 'admin')->forceDelete();
