...
class AiProviderController extends Controller
{
    ...
    public function update(Request $request, AiProvider $aiProvider): RedirectResponse
    {
        ...
        // Update credentials only if api_key is provided and not empty (trim so paste-with-newline is saved correctly)
        $apiKey = isset($validated['api_key']) ? trim((string) $validated['api_key']) : '';
        if ($apiKey !== '') {
