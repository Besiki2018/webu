...
class ProfileController extends Controller
{
    ...
    public function edit(Request $request): Response
    {
        ...
        return Inertia::render('Profile/Edit', [
            ...
            'aiSettings' => $aiSettings ? [
                ...
                'ultra_cheap_mode' => $aiSettings->isUltraCheapMode(),
    ...
    public function updateAiSettings(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'ultra_cheap_mode' => ['nullable', 'boolean'],
        ...
        if (! $canUseOwnKey) {
            ...
            $settings->preferred_model = $validated['preferred_model'] ?? $settings->preferred_model;
            $settings->ultra_cheap_mode = $validated['ultra_cheap_mode'] ?? true;
            $settings->save();
