# Repro: bug_20260304_893ac168789c6f16
...
## Event
```
[console.error] The above error occurred in the <Settings> component:

    at Settings (http://127.0.0.1:5173/resources/js/Pages/Admin/Settings.tsx?t=1772663921070:126:36)
    ...
    at LanguageProvider (http://127.0.0.1:5173/resources/js/contexts/LanguageContext.tsx?t=1772667195561:666:36)
    at AppWrapper (http://127.0.0.1:5173/resources/js/app.tsx?t=1772667195561:30:23)
