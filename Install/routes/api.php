...
use App\Http\Controllers\BugfixerReportController;
...
// Bugfixer: report runtime errors from frontend ErrorBoundary (throttled)
Route::post('/bugfixer/report', [BugfixerReportController::class, 'report'])
    ->middleware('throttle:30,1')
    ->name('api.bugfixer.report');
