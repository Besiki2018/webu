...
export interface Subscription {
    ...
    renewal_retry_limit?: number | null;
...
export type TransactionType = 'subscription_new' | 'subscription_renewal' | 'refund' | 'adjustment' | 'extension' | 'credit_topup';
...
export interface BillingOverviewPlanSummary {
    plan_id: number;
    name: string;
    price: number;
    billing_period: BillingPeriod;
...
export interface BillingOverview {
    current_plan: BillingOverviewPlanSummary | null;
    renewal: {
        date: string | null;
        days_until: number | null;
        state: 'none' | 'upcoming' | 'due' | 'lifetime' | 'past_due' | 'grace' | 'suspended';
    ...
    recommendations: {
        upgrade: BillingOverviewPlanSummary | null;
        downgrade: BillingOverviewPlanSummary | null;
    };
}
