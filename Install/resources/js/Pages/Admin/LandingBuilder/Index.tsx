                            ...
                            <ScrollArea className="h-full relative z-10 bg-background">
                                <div className="p-6 max-w-2xl">
                                    {!sectionTypes[selectedSection.type] ? (
                                        <div className="p-6 rounded-lg border border-amber-500/50 bg-amber-50 dark:bg-amber-950/20 text-center">
                                            <p className="font-medium text-amber-800 dark:text-amber-200">
                                                Missing section type: {selectedSection.type}
                                            </p>
                                            <p className="mt-1 text-sm text-muted-foreground">
                                                {t('This section type is not in the catalog. Add it or remove the section.')}
                                            </p>
                                        </div>
                                    ) : (
                                        <>
