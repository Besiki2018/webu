...
export function useBuilderWorkspace({
    ...
    const {
        ...
        selectedAiTargetMentions: state.selectedAiTargetMentions,
        upsertAiTargetMention: state.upsertAiTargetMention,
        removeAiTargetMention: state.removeAiTargetMention,
        clearAiTargetMentions: state.clearAiTargetMentions,
        aiFlashNodeIds: state.aiFlashNodeIds,
        aiFlashNonce: state.aiFlashNonce,
        flashAiTargetNodes: state.flashAiTargetNodes,
        clearAiTargetFlash: state.clearAiTargetFlash,
    })));
