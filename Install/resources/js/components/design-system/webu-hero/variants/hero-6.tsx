...
/** Background image hero – bindings: title, subtitle, button, hero_image */
export function Hero6({
  ...
  return (
    <section className="webu-hero webu-hero--hero-6" style={style}>
      <div className="webu-hero__inner webu-hero__inner--centered">
