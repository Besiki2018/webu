...
export function FeaturesBento({ content, items, settings: _settings }: FeaturesBentoProps = {}) {
    ...
    return (
        <section id="features" className="webu-features-bento py-16 lg:py-20 border-t border-border/60">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Section Header */}
                <div className="text-center mb-12">
                    <h2 className="webu-features-bento__title text-3xl md:text-4xl font-semibold tracking-tight mb-4">
                        {title}
                    </h2>
                    ...
                    {features.map((feature) => {
                        ...
                        return (
                            <Card
                                key={feature.id}
                                className={cn(
                                    'group border border-border shadow-none hover:bg-accent/40 transition-colors',
