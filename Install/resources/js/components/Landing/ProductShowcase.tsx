...
export function ProductShowcase({ content, items, settings }: ProductShowcaseProps = {}) {
    ...
    return (
        <section className="webu-product-showcase py-16 lg:py-20 border-t border-border/60">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Section Header */}
                <div className="text-center mb-12">
                    <h2 className="webu-product-showcase__title text-3xl md:text-4xl font-semibold tracking-tight mb-4">
                        {title}
                    </h2>
