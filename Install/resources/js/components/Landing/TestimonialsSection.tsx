...
export function TestimonialsSection({ content, items, settings: _settings }: TestimonialsSectionProps = {}) {
    ...
    return (
        <section className="webu-testimonials-section py-16 lg:py-20 border-t border-border/60">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Section Header */}
                <div className="text-center mb-12">
                    <h2 className="webu-testimonials-section__title text-3xl md:text-4xl font-semibold tracking-tight mb-4">
                        {title}
                    </h2>
                    ...
                    {canScroll && (
                        <>
                            <Button
                                variant="outline"
                                size="icon"
                                className="absolute start-0 top-1/2 -translate-y-1/2 z-10 hidden md:flex rounded-full bg-background hover:bg-accent"
                                onClick={scrollPrev}
                            ...
                            <Button
                                variant="outline"
                                size="icon"
                                className="absolute end-0 top-1/2 -translate-y-1/2 z-10 hidden md:flex rounded-full bg-background hover:bg-accent"
                                onClick={scrollNext}
                                aria-label={t('Next')}
                            >
                    ...
                    <div className="overflow-hidden" ref={emblaRef}>
                        <div className="flex">
                            {testimonials.map((testimonial, index) => (
                                ...
                                >
                                    <Card className="h-full group border border-border shadow-none hover:bg-accent/40 transition-colors">
