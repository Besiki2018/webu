...
function PlanCard({ plan, t }: { plan: Plan; t: TranslationFn }) {
    ...
    return (
        <Card
            className={cn(
                'flex flex-col relative border border-border shadow-none',
...
export function PricingSection({ plans, content, settings: _settings }: PricingSectionProps) {
    ...
    return (
        <section id="pricing" className="webu-pricing-section py-16 lg:py-20 border-t border-border/60">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="webu-pricing-section__title text-3xl md:text-4xl font-semibold tracking-tight mb-4">
                        {title}
                    </h2>
