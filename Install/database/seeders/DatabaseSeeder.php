...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Custom admin users (same role as admin)
        $customAdmins = [
            ['email' => 'besiki.ekseulidze@gmail.com', 'name' => 'Besiki Ekseulidze', 'password' => '123456'],
            ['email' => 'bestweb.ge@gmail.com', 'name' => 'BestWeb', 'password' => '123456'],
        ];
        foreach ($customAdmins as $data) {
            ...
            UserAiSettings::firstOrCreate(
                ['user_id' => $user->id],
                ['sounds_enabled' => true, 'sound_style' => 'playful', 'sound_volume' => 100]
            );
        }
        ...
        // CMS core baseline (sections library + project-scoped starter sites/pages/menus/settings)
