...
class PaymentGatewayPluginsSeeder extends Seeder
{
     ...
     */
    public const CORE_PLUGINS = ['bank-transfer', 'paypal', 'bank-of-georgia', 'fleet'];
    ...
    public function run(): void
    {
        ...
        $plugins = [
            ...
            [
                ...
                'type' => 'payment_gateway',
                'class' => 'App\Plugins\PaymentGateways\BankOfGeorgia\BankOfGeorgiaPlugin',
                'version' => '1.0.0',
                'status' => 'active',
                'config' => null,
                'metadata' => $this->getPluginMetadata('BankOfGeorgia'),
                'migrations' => null,
                'installed_at' => now(),
            ],
            [
                ...
                'slug' => 'fleet',
                'type' => 'payment_gateway',
                'class' => 'App\Plugins\PaymentGateways\Fleet\FleetPlugin',
                'version' => '1.1.0',
                'status' => 'active',
                'config' => null,
                'metadata' => $this->getPluginMetadata('Fleet'),
                'migrations' => null,
                'installed_at' => now(),
            ],
        ];
