...
class SystemSettingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $defaultBuilderId = Builder::query()
            ->where('status', 'active')
            ->orderBy('id')
            ->value('id');
        $defaultAiProviderId = AiProvider::query()
            ->where('status', 'active')
            ->orderBy('id')
            ->value('id');
        ...
        $settings = [
            ...
            ['key' => 'default_locale', 'value' => 'ka', 'type' => 'string', 'group' => 'general'],
            ...
            // Plans Settings
            ['key' => 'default_plan_id', 'value' => $defaultPlanId, 'type' => 'integer', 'group' => 'plans'],
            ['key' => 'default_builder_id', 'value' => $defaultBuilderId, 'type' => 'integer', 'group' => 'plans'],
            ['key' => 'default_ai_provider_id', 'value' => $defaultAiProviderId, 'type' => 'integer', 'group' => 'plans'],
